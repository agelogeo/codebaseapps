  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <p>By accessing and using the Keibo mobile application, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.</p>
      </section>

      {/* Description of Service */}
      <section>
        <h2>Description of Service</h2>
        <p>Keibo is a mobile application developed by Codebase Apps that provides users with personal productivity and organizational tools. The specific features and functionality may be updated from time to time at our discretion.</p>
      </section>
      ...
      >
        ...
        <p>By using the Keibo application, you acknowledge that you have read and understood these Terms of Service and agree to be bound by them.</p>
      </section>
    </LegalPageTemplate>
  );
};

export default KeiboTerms;
