...
class KeiboTermsPage extends StatelessWidget {
  const KeiboTermsPage({super.key});
    ...
    return LegalPageTemplate(
      ...
      sections: const [
        LegalSection(
          ...
          paragraphs: [
            'By accessing and using the Keibo mobile application, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.',
          ],
        ),
        LegalSection(
          title: 'Description of Service',
          paragraphs: [
            'Keibo is a mobile application developed by Codebase Apps that provides users with personal productivity and organizational tools. The specific features and functionality may be updated from time to time at our discretion.',
          ],
        ),
        LegalSection(
          title: 'User Accounts',
      ...
      footerText:
          'By using the Keibo application, you acknowledge that you have read and understood these Terms of Service and agree to be bound by them.',
    );
  }
}
